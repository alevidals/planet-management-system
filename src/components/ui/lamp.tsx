    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          whileInView={{ opacity: 1, width: isDesktop ? "30rem" : "15rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        <motion.div
          initial={{ width: isDesktop ? "8rem" : "4rem" }}
          whileInView={{ width: isDesktop ? "16rem" : "8rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        <motion.div
          ...
          whileInView={{ width: isDesktop ? "30rem" : "15rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
